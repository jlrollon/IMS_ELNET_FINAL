<%@ Page Title="Warehouse" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="warehouse.aspx.cs" Inherits="IMS_ELNET_FP.warehouse" %>
            ...
            <div class="sidebar text-center">
                ...
                <nav>
                    <div class="text-start">
                        ...
                        <div>
                            <a class="d-flex align-items-center bg-light p-1 ps-3 text-dark" href="/warehouse">
...
<div><a class="d-flex align-items-center p-1 ps-3 text-light" href="/personnels" title="Personnels"><i class="fa-solid fa-user text-light"></i>&nbsp;&nbsp;Personnels</a></div>
            ...
            <div class="side">
                ...
                <section>
                    <div class="content warehouse-content m-4 pt-3 p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex gap-5">
                                <trong class="fs-3 fw-bold">Manage Your Warehouse</trong>
                            </div>
                        </div>
                        <div class="mt-3">
                            <div class="table-content">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table align-middle">
                                    <Columns>
                                        <asp:BoundField DataField="RACK_NUM" HeaderText="Rack Number" SortExpression="RACK_NUM">
                                        ...
                                        <asp:BoundField DataField="STOCKS_IN_RACK" HeaderText="Stocks" SortExpression="STOCKS_IN_RACK">
                                            <HeaderStyle BackColor="#374259" ForeColor="White" Font-Bold="true" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="AVAILABLE_CAPACITY" HeaderText="Available Capacity" SortExpression="AVAILABLE_CAPACITY">
                                            <HeaderStyle BackColor="#374259" ForeColor="White" Font-Bold="true" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="PRODUCTS_ACTIVITY" HeaderText="Activities" SortExpression="PRODUCTS_ACTIVITY">
                                            <HeaderStyle BackColor="#374259" ForeColor="White" Font-Bold="true" />
                                        </asp:BoundField>
                                    </Columns>
                                    <EmptyDataTemplate>
                                        <p class="fs-3"><%= nodata %></p>
                                    </EmptyDataTemplate>
                                </asp:GridView>
                            </div>
                        </div>
