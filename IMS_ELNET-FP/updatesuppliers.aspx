<%@ Page Title="Update Suppliers" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="updatesuppliers.aspx.cs" Inherits="IMS_ELNET_FP.updatesuppliers" %>
        ...
        <div class="sidebar text-center">
            ...
            <nav>
                <div class="text-start">
                    ...
                    <div><a class="d-flex align-items-center p-1 ps-3 text-dark bg-light" href="/suppliers"><i class="fa-solid fa-truck-field"></i>&nbsp;&nbsp;Suppliers</a></div>
                        ...
                        <div class="create-card p-3 ps-4 pe-4">
                            ...
                            <div class="d-flex flex-column gap-4 mt-3">
                                ...
                                <div class="d-flex align-items-center gap-5">
                                    ...
                                    <asp:TextBox ID="supp_id" runat="server" CssClass="form-control" name="supp_id" placeholder="Supplier ID"></asp:TextBox>
                                </div>
                                <div class="d-flex align-items-center gap-5">
                                    <span style="width: 20%;">
                                        <label for="comp_name">Company Name</label>
                                    </span>
                                    <asp:TextBox ID="comp_name" runat="server" CssClass="form-control" name="comp_name" placeholder="Company Name"></asp:TextBox>
                                </div>
                                <div class="d-flex align-items-center gap-5">
                                    <span style="width: 20%;">
                                ...
                                <div class="d-flex align-items-center gap-5">
                                    ...
                                    <asp:TextBox ID="others" runat="server" CssClass="form-control" name="others" placeholder="Other details"></asp:TextBox>
                                </div>
                                <div class="create-submition mb-3">
                                    <asp:Button ID="AddBtn" runat="server" Text="Submit" CssClass="text-light form-control" OnClick="updateSupplier"/>
                                </div>
                            </div>
                        </div>
                    </div>
